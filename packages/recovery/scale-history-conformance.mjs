...
export async function runScaleHistoryConformance({ transitions = 10_000, outputDirectory = undefined } = {}) {
  ...
  const result = {
    ...
    algorithms: { transitionReference: 'packages/core/shielded-transition.mjs (circomlibjs Poseidon)', portableRecovery: 'packages/recovery/chain-history.mjs plus portable-core.mjs (poseidon-lite/BabyJubJub/Poseidon record masks)', comparison: 'exact owned-note ledger and terminal state equality' },
