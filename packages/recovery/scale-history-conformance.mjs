...
class Builder {
  ...
  async output(kind) {
    ...
    const note = this.reference.deriveNote({ profileId: this.profileId, instanceId: this.instanceId, sk: this.wallet.spendSecret, rho: created.output.rho, r: created.output.r });
