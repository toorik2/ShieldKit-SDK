...
const preparationPrimitive = () => import('../preparation-transaction/preparation-transaction.mjs');
const settlementPrimitive = () => import('../settlement-transaction/settlement-transaction.mjs');
const witnessPrimitive = () => import('../g2-complete-assembler/g2-complete-assembler.mjs');
const genesisPrimitive = () => import('../chipnet-genesis/chipnet-genesis.mjs');
...
export async function createDesktopWalletSdk(value) {
