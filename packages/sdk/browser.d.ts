...
/** V2 address points bind to `ak`; they are not serialized in a recovery record. */
export interface RecipientAddress { readonly schema: 'shield.cash/recipient-address/v2'; readonly profileId: string; readonly instanceId: string; readonly ak: string; readonly spendPublicKey: string; readonly recoveryPublicKey: string; }
...
/** Packet bytes remain SCAR/action-packet v1; recovery semantics are V2. */
export interface ChainHistoryRecovery { readonly schema: 'shield.cash/chain-history-recovery/v2'; readonly qualification: string; readonly profileId: string; readonly instanceId: string; readonly initialState: ActionState; readonly terminalState: ActionState; readonly notes: readonly RecoveredNote[]; readonly unspentNotes: readonly RecoveredNote[]; readonly spentNullifiers: readonly string[]; }
...
export function createBrowserWalletSdk(value: { profile: ProfileCoordinates }): Readonly<{
  schema: 'shield.cash/browser-wallet-sdk/v2'; profile: ProfileCoordinates; qualification: string;
