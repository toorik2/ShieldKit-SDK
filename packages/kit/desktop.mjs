...
const preparationPrimitive = () => import('../action/prep.mjs');
const settlementPrimitive = () => import('../action/settlement.mjs');
const witnessPrimitive = () => import('../action/assemble.mjs');
const genesisPrimitive = () => import('../profile/genesis.mjs');
