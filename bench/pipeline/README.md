...
| `designs/pf10/bench` S0/S1/S2 | `shieldkit-component-bench-scorecard-v1` | Component prove/scaling microbenchmarks |
...
node bench/pipeline/promote.mjs bench/results/smoke/pf10-deposit.json
```
...
```bash
node --test bench/pipeline/*.test.mjs
```
