...
const CLI = path.join(SDK_ROOT, 'shieldkit-groth-94kb/scripts/shieldkit.mjs');
...
export function runPf10Action(opts) {
  ...
  const env = captureEnvironment({ designRoot: path.join(SDK_ROOT, 'shieldkit-groth-94kb') });
