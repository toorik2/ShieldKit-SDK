/**
 * FRI-STARK real-action adapter: drives shieldkit-fri-stark-96kb Chipnet stories.
...
const DESIGN_ROOT = path.join(SDK_ROOT, 'shieldkit-fri-stark-96kb');
...
export function runFriAction(opts) {
  ...
  if (!existsSync(DESIGN_ROOT)) {
    return buildFailClosedRun({
      ...
      reason: 'shieldkit-fri-stark-96kb missing',
      cacheMode,
      environment: env,
    });
  }
