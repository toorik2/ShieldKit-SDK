...
export function printHelp(stream = process.stdout) {
  stream.write(
    ...
    + '\n'
    + 'usage:\n'
    + '  node bench/action/run-action.mjs --design pf10|pf6|fri --action deposit|transfer|withdrawal [options]\n'
    ...
    + 'results under bench/results/ are gitignored; use bench/action/promote.mjs to promote\n',
  );
}
