...
| Field | Value |
|-------|--------|
| Ref | `previous-versions/02-use-chipnet-demo-pool` (`playground`, `chipnet-playground`) |
...
| Descriptor | [`../../previous-versions/02-use-chipnet-demo-pool/instance.json`](../../previous-versions/02-use-chipnet-demo-pool/instance.json) |
