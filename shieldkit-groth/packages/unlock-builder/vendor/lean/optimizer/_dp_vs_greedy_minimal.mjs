...
import { compileFileBytecode, commitBin, CATEGORY, TARGET_UNLOCK } from '/home/toorik/Projects/verifier.cash/build/chunked/pairing/_millermath.mjs';
import { bigIntToVmNumber, encodeDataPush, encodeLockingBytecodeP2sh32, hash256, createVirtualMachineBch2026, binToHex } from '/home/toorik/Projects/verifier.cash/build/node_modules/@bitauth/libauth/build/index.js';
...
writeFileSync('/home/toorik/Projects/LeanBCH/optimizer/_dp_vs_greedy_minimal_report.json', JSON.stringify({ cuts, dpMillerMinimalBytes: total, dpChunks: rows.length, greedyMillerBytes: 191475, greedyChunks: 21, delta: total - 191475, maxOpMaxPad: maxOpMax, rows }, null, 2));
