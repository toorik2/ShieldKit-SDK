...
function validateManifest(manifest) {
  ...
  if (manifest.network.name !== 'chipnet' && manifest.network.name !== 'mainnet') {
    fail('network must be chipnet or mainnet');
  }
...
function validateExpectedInstanceBinding(expected) {
  ...
  if (expected.network !== 'chipnet' && expected.network !== 'mainnet') {
    fail('expected network binding must be chipnet or mainnet');
  }
