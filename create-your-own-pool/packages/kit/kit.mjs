...
export async function createKit(config) {
  ...
  return Object.freeze({
    ...
    planGenesis: desktop.planGenesis.bind(desktop),
    finalizeGenesis: desktop.finalizeGenesis.bind(desktop),
    serializeCompleteSettlement: desktop.serializeCompleteSettlement.bind(desktop),
