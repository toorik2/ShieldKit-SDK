...
import { createShieldedTransitionReference, DOMAIN_TAGS, frToHex } from '../action/transition.mjs';
...
export async function runScaleHistoryConformance({ transitions = 10_000, outputDirectory = undefined } = {}) {
  ...
  const result = {
    ...
    algorithms: { transitionReference: 'packages/action/transition.mjs (circomlibjs Poseidon)', portableRecovery: 'packages/recover/chain-history.mjs plus portable-core.mjs (poseidon-lite/BabyJubJub/Poseidon record masks)', comparison: 'exact owned-note ledger and terminal state equality' },
