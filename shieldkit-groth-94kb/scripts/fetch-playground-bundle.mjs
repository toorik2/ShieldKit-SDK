...
const instancePath = path.join(monorepoRoot, 'archived-pool-designs/02-use-chipnet-demo-pool/instance.json');
...
async function main() {
  ...
  const outDir = assertSafeReplaceDirectory(
    arg('out', path.join(monorepoRoot, 'archived-pool-designs/02-use-chipnet-demo-pool/bundle')),
