...
See [docs/PRIVACY.md](shieldkit-groth-94kb/docs/PRIVACY.md) for claim bounds (RPC query privacy **outside** claim).
...
1. `development-only` and `local-contribution-simulation` are not production qualification. Production privacy needs independently governed [external contributions](shieldkit-groth-94kb/docs/EXTERNAL_CONTRIBUTIONS.md), audit, and a new genesis ([CHARTER](shieldkit-groth-94kb/docs/CHARTER.md)).
