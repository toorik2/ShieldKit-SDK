...
| Field | Value |
|-------|--------|
| Ref | `archived-pool-designs/02-use-chipnet-demo-pool` (`playground`, `chipnet-playground`) |
...
| Descriptor | [`../../archived-pool-designs/02-use-chipnet-demo-pool/instance.json`](../../archived-pool-designs/02-use-chipnet-demo-pool/instance.json) |
