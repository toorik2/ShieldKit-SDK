...
function packetsAndRecords(profileId, instanceId) {
  ...
  let current = createDirectV2PoolModel({ profileId, maximumLiveNotes: '32', denominationSats: '10000000' });
