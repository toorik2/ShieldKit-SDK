...
function libauthEvidence({ profileId, instanceId, proofArtifactHashes, runtimeMaterialSha256 }) {
  ...
  return {
    ...
    pf10FusedQGenesisActions: {
      ...
      actionCount: 3,
      actions: [
        action('deposit', 97_844, 13, 0x44),
        action('transfer', 97_844, 13, 0x54),
        action('withdrawal', 97_878, 14, 0x57),
      ],
      fixedLineDerivation,
      fixedPrograms: {
        ...
        fusedRedeemBytes: 6396,
        loaderBytes: 108,
        millerRawBytes: 5422,
        millerRedeemBytes: 4612,
...
async function writeCanonicalPf10RuntimeBundle(authenticated, runtimeRoot, descriptorFinalLocks) {
  ...
  const buildAttestation = canonicalCircuitBuildAttestation({
    ...
    compilation: {
      argv: ['node_modules/circom2/cli.js', '03-create-your-own-pool/circuits/v2-direct/main-chipnet.circom', '--r1cs', '--wasm', '--sym', '--O1', '--sanity_check', '2', '--output', '$BUILD_OUTPUT'],
