...
const BASE_VERIFIER_FILES = Object.freeze([
  '03-create-your-own-pool/packages/action/v2/binding-unlock.mjs',
  '03-create-your-own-pool/packages/action/v2/topology.mjs',
  ...PRODUCTION_V2_MODULES.map((name) =>
    `03-create-your-own-pool/packages/unlock-builder/v2/${name}`),
  '03-create-your-own-pool/packages/unlock-builder/vendor/verifier/build/chunked/pairing/_millermath.mjs',
  ...
  '03-create-your-own-pool/packages/unlock-builder/vendor/verifier/lanes/bn254-onetx/src/c7/shield-adapter-input.mjs',
...
const BASE_VERIFIER_DIRECTORIES = Object.freeze([
  ...
  '03-create-your-own-pool/packages/unlock-builder/vendor/verifier/vendor/cashc-resched/packages/cashc/dist',
]);
...
async function toolchainManifest(repositoryRoot) {
  ...
  const cashcPackage = await stableFileEvidence(
    ...
    path.join(
      repositoryRoot,
      '03-create-your-own-pool/packages/unlock-builder/vendor/verifier/vendor/cashc-resched/packages/cashc/package.json',
    ),
