...
Optional live demo (sibling dir): [`../02-use-chipnet-demo-pool/`](../02-use-chipnet-demo-pool/).
...
node 03-create-your-own-pool/scripts/shieldkit.mjs init --config 03-create-your-own-pool/templates/init.development.json
```
