  ...
  const evidence = {
    ...
    provenance: {
      ...
      commands: {
        campaign: {
          executable: 'node',
          arguments: ['03-create-your-own-pool/scripts/v2-q04-campaign.mjs'],
          workingDirectory: '.',
        },
        rustKatBuild: {
          executable: 'cargo',
          ...
          workingDirectory:
            '03-create-your-own-pool/crates/shieldkit-v2-recovery',
        },
        rustKatRun: {
...
test('[test-only] schema v3 binds exact lanes, checker, telemetry, source set, and replay boundary', () => {
  ...
  assert.ok(Q04_SOURCE_DEFINITIONS.campaign.some((entry) =>
    entry.originPath ===
      '03-create-your-own-pool/scripts/v2-q04-campaign.mjs'
  ));
