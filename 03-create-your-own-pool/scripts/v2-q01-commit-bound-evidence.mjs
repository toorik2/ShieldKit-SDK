...
const STATE_VECTOR_PATH =
  '03-create-your-own-pool/packages/action/v2/vectors/q01-state-boundary-vectors.jsonl';
const TYPESCRIPT_TSC_PATH = 'node_modules/typescript/bin/tsc';
const TYPESCRIPT_CONFIG_PATH =
  '03-create-your-own-pool/packages/action/v2/typescript/tsconfig.json';
const CIRCOM_CLI_PATH = 'node_modules/circom2/cli.js';
const CIRCUIT_TEST_PATH =
  '03-create-your-own-pool/packages/action/v2/circuit-codec-vectors.test.mjs';
const COVENANT_TEST_PATH =
  '03-create-your-own-pool/packages/unlock-builder/v2/structural-covenants.test.mjs';
const RUST_MANIFEST_PATH =
  '03-create-your-own-pool/crates/shieldkit-v2-codec/Cargo.toml';
const RUST_LOCK_PATH =
  '03-create-your-own-pool/crates/shieldkit-v2-codec/Cargo.lock';
const RUST_TEST_PATH =
  '03-create-your-own-pool/crates/shieldkit-v2-codec/tests/vectors.rs';
const RUST_TOOLCHAIN_PATH = '03-create-your-own-pool/rust-toolchain.toml';
...
const TYPESCRIPT_RUNNER = [
  ...
  "import { canonicalJson } from './03-create-your-own-pool/packages/profile/load.mjs';",
  "import { runStrictCodecQualification } from './03-create-your-own-pool/packages/action/v2/strict-codec-qualification.mjs';",
  "import { actionPacketPublicLimbs as jsLimbs, decodeActionPacket as decodeJsPacket, encodeActionPacket as encodeJsPacket } from './03-create-your-own-pool/packages/action/v2/packet.mjs';",
  "import { decodeStateNftCommitment as decodeJsState, encodeStateNftCommitment as encodeJsState } from './03-create-your-own-pool/packages/action/v2/state.mjs';",
