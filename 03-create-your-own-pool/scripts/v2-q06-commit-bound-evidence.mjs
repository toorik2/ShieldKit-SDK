...
const crashScript = '03-create-your-own-pool/scripts/v2-crash-qualification.mjs';
const reorgScript = '03-create-your-own-pool/scripts/v2-reorg-concurrency-qualification.mjs';
