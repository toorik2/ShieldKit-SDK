 ...
 *
 * Usage:
 *   node 03-create-your-own-pool/scripts/fetch-playground-bundle.mjs
 *   node 03-create-your-own-pool/scripts/fetch-playground-bundle.mjs --out 02-use-chipnet-demo-pool/bundle
 */
...
async function main() {
  ...
  console.error('node 03-create-your-own-pool/scripts/shieldkit.mjs playground doctor');
}
