...
import { buildClassCostVec, normalizeParams, validateCostVec, planOptimal, chunkBytes, compileVerify, localBoundarySearch, cutsOf } from '/home/toorik/Projects/ZK-Proofs/LeanBCH/optimizer/chunkplan.mjs';
...
writeFileSync('/home/toorik/Projects/ZK-Proofs/LeanBCH/optimizer/_validate_fresh_partitions_report.json', JSON.stringify({ ...out, fullRows: results }, null, 2));
