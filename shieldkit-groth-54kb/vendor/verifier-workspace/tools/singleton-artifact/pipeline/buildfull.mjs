...
for (const id of d.order) {
  ...
  const { bytes, chosen } = optimizeItems(items, arity, 'sched', { peephole: true });
...
const { bytes: mainOpt, chosen: mainChosen } = optimizeItems(mainItems, arity, 'sched', { peephole: true });
