...
import { createRealVm, evaluatePair } from '/home/toorik/Projects/ZK-Proofs/shieldkit-sdk/shieldkit-groth-54kb/vendor/verifier-workspace/harness/src/harness/vm.ts';
...
for (const i of [4, 5]) {
  ...
  console.log('role', i, ':', out.accepted, '|', (out.error || '').slice(0, 120));
}
