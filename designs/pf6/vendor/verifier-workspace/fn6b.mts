...
console.log('table keys:', Object.keys(ft).join(','));
console.log('key 6 exists:', Object.hasOwn(ft, 6) || Object.hasOwn(ft, '6'));
if (ft['6'] !== undefined) console.log('f6:', la.binToHex(Uint8Array.from(ft['6'])));
