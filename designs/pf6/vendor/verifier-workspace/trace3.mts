...
const program = {
  ...
  transaction: { version: 2, inputs: inputs.map((i, n) => ({ outpointTransactionHash: tx.inputs[n].outpointTransactionHash, outpointIndex: tx.inputs[n].outpointIndex, sequenceNumber: 0, unlockingBytecode: i.unlockingBytecode })), outputs, locktime: 0 },
  spentOutputs: [],
};
