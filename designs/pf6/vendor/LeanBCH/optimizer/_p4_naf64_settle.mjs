...
import { buildClassCostVec, normalizeParams, planOptimal } from '/home/toorik/Projects/ZK-Proofs/LeanBCH/optimizer/chunkplan.mjs';
...
const J = JSON.parse(readFileSync('/home/toorik/Projects/ZK-Proofs/LeanBCH/optimizer/bn254_costvec_deployed_selfpin.json', 'utf8'));
...
{
  const { chunkBytes } = await import('/home/toorik/Projects/ZK-Proofs/LeanBCH/optimizer/chunkplan.mjs');
  const { costVec, params } = assemble(J.classOf, J.boundaryStateBytes, J.finalForcedCut);
