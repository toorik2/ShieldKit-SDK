...
export function printHelp(stream = process.stdout) {
  ...
  stream.write(
    ...
    + '\n'
    + '  node designs/pf10/bench/pf10-baseline/run-bench.mjs --data-home ABS [options]\n'
    + '  node designs/pf10/bench/pf10-baseline/run-bench.mjs --cold-start --data-home ABS [options]\n'
    + '\n'
    + 'required:\n'
    ...
    + '  • see docs/product/start.md and designs/pf10/bench/README.md.\n',
  );
}
