...
test("Q-04 Rust layout cannot select a checkout-stale binary", (t) => {
  ...
  const command = rustBuildCommand("/immutable/snapshot/designs/pf10/crates/shieldkit-v2-recovery", layout);
  assert.equal(command.cwd, "/immutable/snapshot/designs/pf10/crates/shieldkit-v2-recovery");
  ...
  const checkerCommand = rustCheckerBuildCommand(
    "/immutable/snapshot/designs/pf10/crates/shieldkit-v2-q04-certificate",
    layout,
  );
  assert.equal(
    checkerCommand.cwd,
