...
test('Q07 resume snapshots a newly built binary and binds systemd to that immutable artifact', (t) => {
  ...
  const target = join(root, 'designs', 'pf10', 'crates', 'shieldkit-v2-recovery', 'target', 'release', 'q07-lifecycle-verify');
  mkdirSync(bundle, { mode: 0o700 });
  mkdirSync(join(root, 'designs', 'pf10', 'crates', 'shieldkit-v2-recovery', 'target', 'release'), { recursive: true });
