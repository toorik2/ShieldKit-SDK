...
export const Q04_SOURCE_DEFINITIONS = Object.freeze({
  productionCore: Object.freeze([
    Object.freeze({
      ...
      originPath: 'designs/pf10/packages/pool/v2/qualification/persistent-nullifier-store.mjs',
    }),
    Object.freeze({
      role: 'shared-production-insertion-core',
      originPath: 'designs/pf10/packages/pool/v2/persistent-indexed-nullifier.mjs',
    }),
    Object.freeze({
      role: 'shared-production-sqlite-adapter',
      originPath: 'designs/pf10/packages/pool/v2/persistent-indexed-nullifier-sqlite.mjs',
    }),
    Object.freeze({
      role: 'production-poseidon',
      originPath: 'designs/pf10/packages/action/v2/poseidon.mjs',
    }),
    Object.freeze({
      role: 'production-domains',
      originPath: 'designs/pf10/packages/action/v2/domains.mjs',
    }),
  ]),
  primaryJsOracle: Object.freeze([
    Object.freeze({
      role: 'independent-bigint-poseidon',
      originPath: 'designs/pf10/packages/pool/v2/qualification/independent-poseidon-oracle.mjs',
    }),
    Object.freeze({
      role: 'independent-treap-tree',
      originPath: 'designs/pf10/packages/pool/v2/qualification/independent-indexed-nullifier-tree.mjs',
    }),
    Object.freeze({
  ...
  rustKat: Object.freeze([
    Object.freeze({
      ...
      originPath: 'designs/pf10/crates/shieldkit-v2-recovery/src/bin/q04-poseidon-oracle.rs',
    }),
    Object.freeze({
      role: 'codec-modulus-source',
      originPath: 'designs/pf10/crates/shieldkit-v2-codec/src/lib.rs',
    }),
    Object.freeze({
      role: 'compiled-codec-module',
      originPath: 'designs/pf10/crates/shieldkit-v2-codec/src/notes.rs',
    }),
    Object.freeze({
      role: 'codec-manifest',
      originPath: 'designs/pf10/crates/shieldkit-v2-codec/Cargo.toml',
    }),
  ]),
  depth4Checker: Object.freeze([
    Object.freeze({
      ...
      originPath:
        'designs/pf10/crates/shieldkit-v2-q04-certificate/src/main.rs',
    }),
    Object.freeze({
      role: 'rust-certificate-checker-manifest',
      originPath:
        'designs/pf10/crates/shieldkit-v2-q04-certificate/Cargo.toml',
    }),
    Object.freeze({
      role: 'rust-certificate-checker-lockfile',
      originPath:
        'designs/pf10/crates/shieldkit-v2-q04-certificate/Cargo.lock',
    }),
    Object.freeze({
      role: 'rust-certificate-checker-toolchain',
      originPath: 'designs/pf10/rust-toolchain.toml',
    }),
  ]),
  campaign: Object.freeze([
    Object.freeze({
      role: 'history-schedule',
      originPath: 'designs/pf10/packages/pool/v2/qualification/q04-schedule.mjs',
    }),
    Object.freeze({
      role: 'history-runner',
      originPath: 'designs/pf10/scripts/v2-q04-history-runner.mjs',
    }),
    Object.freeze({
      role: 'campaign-driver',
      originPath: 'designs/pf10/scripts/v2-q04-campaign.mjs',
    }),
    Object.freeze({
      role: 'segment-worker',
      originPath: 'designs/pf10/scripts/v2-q04-segment-worker.mjs',
    }),
    Object.freeze({
      role: 'canonical-checkpoint-probes',
      originPath:
        'designs/pf10/packages/pool/v2/qualification/q04-checkpoint-probes.mjs',
    }),
    Object.freeze({
      role: 'reopen-worker',
      originPath: 'designs/pf10/scripts/v2-q04-reopen-worker.mjs',
    }),
    Object.freeze({
      role: 'strict-json-parser',
      originPath: 'designs/pf10/packages/profile/load.mjs',
    }),
    Object.freeze({
      role: 'evidence-verifier',
      originPath: 'designs/pf10/scripts/v2-q04-evidence-verify.mjs',
    }),
  ]),
  depth4: Object.freeze([
    Object.freeze({
      ...
      originPath:
        'designs/pf10/packages/pool/v2/qualification/depth4-production-state-space.mjs',
    }),
    Object.freeze({
      role: 'generic-action-indexed-nullifier-tree-model',
      originPath:
        'designs/pf10/packages/action/v2/indexed-nullifier-tree.mjs',
    }),
    Object.freeze({
      role: 'shared-kernel-symbolic-template-certificate',
      originPath:
        'designs/pf10/packages/pool/v2/qualification/depth4-symbolic-certificate.mjs',
    }),
  ]),
});
...
const RUST_MANIFEST_DEFINITION = sourceDefinition(
  'rust-kat-manifest',
  'designs/pf10/crates/shieldkit-v2-recovery/Cargo.toml',
);
const RUST_LOCK_DEFINITION = sourceDefinition(
  'rust-kat-lockfile',
  'designs/pf10/crates/shieldkit-v2-recovery/Cargo.lock',
);
const RUST_TOOLCHAIN_DEFINITION = sourceDefinition(
  'rust-toolchain',
  'designs/pf10/rust-toolchain.toml',
);
...
function validateProvenance(provenance, references, sourceMaterials) {
  ...
  validateCommand(provenance.commands.rustKatBuild, 'provenance.commands.rustKatBuild', {
    ...
    workingDirectory: 'designs/pf10/crates/shieldkit-v2-recovery',
  });
  ...
  validateCommand(
    ...
    'provenance.commands.depth4CheckerBuild',
    {
      ...
      workingDirectory:
        'designs/pf10/crates/shieldkit-v2-q04-certificate',
    },
  );
  validateCommand(
    ...
    'provenance.commands.depth4CheckerRun',
    {
      ...
      arguments: [
        ...
        'snapshot/designs/pf10/packages/pool/v2/persistent-indexed-nullifier.mjs',
        'snapshot/designs/pf10/crates/shieldkit-v2-q04-certificate/src/main.rs',
      ],
      workingDirectory: '.',
    },
  );
