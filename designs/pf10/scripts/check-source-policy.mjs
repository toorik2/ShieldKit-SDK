...
const projectRoot = path.join(repositoryRoot, 'designs/pf10');
...
const allowedRawSenders = new Set([
  'designs/pf10/packages/kit/chipnet-rpc.mjs',
  'designs/pf10/packages/kit/transaction-coordinator.mjs',
]);
