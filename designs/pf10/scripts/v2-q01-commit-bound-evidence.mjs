...
const VECTOR_PATH =
  'designs/pf10/packages/action/v2/vectors/q01-state-packet-public-input.json';
const STATE_VECTOR_PATH =
  'designs/pf10/packages/action/v2/vectors/q01-state-boundary-vectors.jsonl';
const TYPESCRIPT_TSC_PATH = 'node_modules/typescript/bin/tsc';
const TYPESCRIPT_CONFIG_PATH =
  'designs/pf10/packages/action/v2/typescript/tsconfig.json';
const CIRCOM_CLI_PATH = 'node_modules/circom2/cli.js';
const CIRCUIT_TEST_PATH =
  'designs/pf10/packages/action/v2/circuit-codec-vectors.test.mjs';
const COVENANT_TEST_PATH =
  'designs/pf10/packages/unlock-builder/v2/structural-covenants.test.mjs';
const RUST_MANIFEST_PATH =
  'designs/pf10/crates/shieldkit-v2-codec/Cargo.toml';
const RUST_LOCK_PATH =
  'designs/pf10/crates/shieldkit-v2-codec/Cargo.lock';
const RUST_TEST_PATH =
  'designs/pf10/crates/shieldkit-v2-codec/tests/vectors.rs';
const RUST_TOOLCHAIN_PATH = 'designs/pf10/rust-toolchain.toml';
...
const JAVASCRIPT_RUNNER = [
  "import { canonicalJson } from './designs/pf10/packages/profile/load.mjs';",
  "import { runStrictCodecQualification } from './designs/pf10/packages/action/v2/strict-codec-qualification.mjs';",
  "import { actionPacketPublicLimbs, decodeActionPacket, digestActionPacket, encodeActionPacket } from './designs/pf10/packages/action/v2/packet.mjs';",
  "import { decodeStateNftCommitment, encodeStateNftCommitment } from './designs/pf10/packages/action/v2/state.mjs';",
...
const TYPESCRIPT_RUNNER = [
  ...
  "import { canonicalJson } from './designs/pf10/packages/profile/load.mjs';",
  "import { runStrictCodecQualification } from './designs/pf10/packages/action/v2/strict-codec-qualification.mjs';",
  "import { actionPacketPublicLimbs as jsLimbs, decodeActionPacket as decodeJsPacket, encodeActionPacket as encodeJsPacket } from './designs/pf10/packages/action/v2/packet.mjs';",
  "import { decodeStateNftCommitment as decodeJsState, encodeStateNftCommitment as encodeJsState } from './designs/pf10/packages/action/v2/state.mjs';",
