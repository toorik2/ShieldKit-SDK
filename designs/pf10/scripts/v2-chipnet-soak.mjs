...
export function assertV2Q09Q08PairBinding(q08, identity) {
  ...
  if (
    ...
    || !HEX_32.test(q08.d02?.policySha256)
    || q08.d02.policySha256 !== q08.d02.closure.policySha256
