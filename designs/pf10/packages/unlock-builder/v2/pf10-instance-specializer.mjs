...
export async function authenticateV2Pf10BetaRuntimeTemplate({ repositoryRoot, template } = {}) {
  ...
  const lazyAffineLibrary = await readFile(path.join(root, 'designs/pf10/packages/unlock-builder/vendor/verifier/build/singleton/bn254/lib/lazy/Bn254LazyAff_kspec.cash'), 'utf8');
