 ...
 *   - folder lives under designs/pf10/demo/ (not an ambient global pool)
 */
...
export const CHIPNET_PLAYGROUND_DIR = 'designs/pf10/demo/chipnet';
/** @deprecated alias */
  ...
  if (descriptor.role === 'playground') {
    ...
    fail(
      ...
      'Chipnet demo pool profile bundle not found. Fetch pinned release: '
        + '`npm run fetch-playground-bundle` (sha256 in designs/pf10/demo/chipnet/instance.json), '
        + 'or set SHIELDKIT_PLAYGROUND_BUNDLE. See designs/pf10/demo/chipnet/README.md.',
    );
  }
