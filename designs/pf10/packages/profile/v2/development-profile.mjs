...
const BASE_VERIFIER_FILES = Object.freeze([
  'designs/pf10/packages/action/v2/binding-unlock.mjs',
  'designs/pf10/packages/action/v2/topology.mjs',
  ...PRODUCTION_V2_MODULES.map((name) =>
    `designs/pf10/packages/unlock-builder/v2/${name}`),
  'designs/pf10/packages/unlock-builder/vendor/verifier/build/chunked/pairing/_millermath.mjs',
  'designs/pf10/packages/unlock-builder/vendor/verifier/lanes/bn254-onetx/src/c7/v2-direct-groth16-adapter-input.mjs',
  'designs/pf10/packages/unlock-builder/vendor/verifier/lanes/bn254-onetx/src/c7/shield-adapter-input.mjs',
  'designs/pf10/packages/unlock-builder/vendor/verifier/build/singleton/bn254/lib/lazy/Bn254LazyAff_kspec.cash',
]);
const BASE_VERIFIER_DIRECTORIES = Object.freeze([
  'designs/pf10/packages/unlock-builder/vendor/verifier/tools/singleton-artifact',
  'designs/pf10/packages/unlock-builder/vendor/verifier/vendor/cashc-resched/packages/cashc/dist',
]);
...
async function toolchainManifest(repositoryRoot) {
  ...
  const cashcPackage = await stableFileEvidence(
    ...
    path.join(
      repositoryRoot,
      'designs/pf10/packages/unlock-builder/vendor/verifier/vendor/cashc-resched/packages/cashc/package.json',
    ),
